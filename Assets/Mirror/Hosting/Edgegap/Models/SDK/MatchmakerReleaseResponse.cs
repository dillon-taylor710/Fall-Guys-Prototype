...
namespace IO.Swagger.Model {
  ...
  public class MatchmakerReleaseResponse : MatchmakerReleaseResponseBase {
    ...
    [JsonProperty("frontend_component_name")]
    ...
    [JsonProperty("director_component_name")]
    ...
    [JsonProperty("match_function_component_name")]
    ...
    public override string ToString()  {
      ...
      sb.Append("class MatchmakerReleaseResponse {\n");
